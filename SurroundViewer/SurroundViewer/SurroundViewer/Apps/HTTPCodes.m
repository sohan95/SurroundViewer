...
+ (NSString *)descriptionForCode:(HTTPCode)code {
    ...
    switch (code) {
        ...
        case HTTPCode420EnhanceYourCalmTwitter:
        ...
        case HTTPCode424MethodFailureWebDaw:
        ...
        case HTTPCode425UnorderedCollection:
        ...
        case HTTPCode451UnavailableForLegalReasons:
        ...
        case HTTPCode522ConnectionTimedOut:
